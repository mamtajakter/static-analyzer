// lex.yy.cxx generated by reflex 1.5.8 from quack.lxx
...
{
  static const char *REGEX_INITIAL = "(?m)(==)|([<]=)|([>]=)|([(-/:->\\x7b\\x7d])|(class)|(def)|(extends)|(if)|(elif)|(else)|(while)|(return)|(typecase)|(and)|(or)|(not)|([A-Z_a-z]+[0-9A-Z_a-z]*)|([0-9]+)|([\\x09\\x0a\\x0d\\x20]*)|([/][/])|([/][\\x2a])|(\")|(\"\"\")|(.)";
  static const reflex::Pattern PATTERN_INITIAL(REGEX_INITIAL);
  static const char *REGEX_comment = "(?m)([^\\x2a]*)|([\\x2a][^/])|([\\x2a][/])";
  static const reflex::Pattern PATTERN_comment(REGEX_comment);
  static const char *REGEX_scomment = "(?m)([\\x0a])";
...
{ return parser::token::NOT; }
    ...
    */
            ...
            break;
          case 17: // rule at line 113: [A-Z_a-z]+[0-9A-Z_a-z]*
#line 113 "quack.lxx"
...
{ yylval.num = atoi(text()); return parser::token::INT_LIT; }
  ...
  /* Ignore whitespace */
            break;
          case 19: // rule at line 125: [\x09\x0a\x0d\x20]*
#line 125 "quack.lxx"
{ ; }

            break;
          case 20: // rule at line 128: [/][/]
#line 128 "quack.lxx"
{ start(scomment); }
            break;
          case 21: // rule at line 133: [/][\x2a]
#line 133 "quack.lxx"
{ start(comment); }
            break;
...
{ start(Q); }
            break;
          case 23: // rule at line 141: """
#line 141 "quack.lxx"
{ start(QQQ); }

 /* How the quoted strings end */
            break;
          case 24: // rule at line 168: .
#line 168 "quack.lxx"
...
{ start(INITIAL); }
            ...
            break;
          case 1: // rule at line 134: [^\x2a]*
#line 134 "quack.lxx"
{ ; }
            break;
          case 2: // rule at line 135: [\x2a][^/]
#line 135 "quack.lxx"
{ ; }
            break;
          case 3: // rule at line 136: [\x2a][/]
#line 136 "quack.lxx"
{ start(INITIAL); }
            break;
        }
...
{ yylval.str = strdup(string_buf.c_str()); string_buf = ""; start(INITIAL); return parser::token::STRING_LIT; }
            break;
          case 2: // rule at line 152: [\x5c]["0\x5cbfnrt]
#line 152 "quack.lxx"
{ string_buf += text(); }
            break;
          case 3: // rule at line 153: [\x5c].
#line 153 "quack.lxx"
{ report::error(BAD_ESC_MSG + " at line " + std::to_string(lineno())
                    + ", column " + std::to_string(columno()));}

            break;
          case 4: // rule at line 159: \n
#line 159 "quack.lxx"
{report::error(BAD_NL_STR + " at line " + std::to_string(lineno())
                  + ", column " + std::to_string(columno()));}
            break;
          case 5: // rule at line 166: .
#line 166 "quack.lxx"
{ string_buf += text(); }
...
{ start(INITIAL); report::error(BAD_EOF_STR + " at line " + std::to_string(lineno())
            ...
            break;
          case 1: // rule at line 145: """
#line 145 "quack.lxx"
{ yylval.str = strdup(string_buf.c_str()); string_buf = ""; start(INITIAL); return parser::token::STRING_LIT; }

            break;
          case 2: // rule at line 161: \n
#line 161 "quack.lxx"
{ string_buf += text(); }
